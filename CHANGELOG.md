...
* **tflint:** 🐛 bump Azure rules version, fix signature bug e5b35f8

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 bffeb80
* **deps:** update dependency opentofu to v1.12.2 9c31ff6
* **deps:** update dependency opentofu to v1.12.3 5e2abe1
* **deps:** update dependency opentofu to v1.12.4 ebdb59a
* **deps:** update dependency tflint to v0.63.1 695673c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 a38efe8
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 8af8efa
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 3f508ce
* **deps:** update tools 271c88d

## 8.6.11 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 3435b9e

### Miscellaneous Chores

* **deps:** update dependency terraform-docs to v0.23.0 a7d97da
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 f3e6302
* **pre-commit:** 🔧 move to prek 0a3497a
* **tfdocs:** bump tfdocs to v0.22 🔧 be1ea7a

## 8.6.10 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 0d908a8

### Code Refactoring

* update module structure and Github actions 👷 3ae69d6

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing c4641d2
* **deps:** 🔗 update mise conf for OpenTofu 14c2482
* **deps:** update dependency trivy to v0.69.3 c183ca6

## 8.6.9 (2026-03-02)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 362c518

### Miscellaneous Chores

* 🔧 add tflint ignore 9e08b88
* **deps:** 🔗 bump tflint rules version e1b88f2
* **deps:** update dependency tflint to v0.61.0 287ce1b
* **deps:** update dependency trivy to v0.69.1 57130ac
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 7496b7a
* **deps:** update tools 3746ee7
* merge remote-tracking branch 'origin/renovate/tools' e10a7c5
